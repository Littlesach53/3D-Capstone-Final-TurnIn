...
{
    if (selectedItem && selectedItemModel.GetComponent<EquippableItem>())
    {
...
new Vector3(0.35f, 0.6f, 0.65f), Quaternion.Euler(6.5f, 89.5f, -10.5f));
