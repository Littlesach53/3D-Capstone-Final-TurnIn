...
public class PlacebleItem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(transform.position, Vector3.down, out groundHit, boxHeight * 1f, LayerMask.GetMask("Ground")))
        {
            isGrounded = true;
        }
        else
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Wall") || other.CompareTag("Celing"))
        {
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.CompareTag("Wall") || other.CompareTag("Celing") && PlacementSystem.Instance.inPlacementMode)
        {
