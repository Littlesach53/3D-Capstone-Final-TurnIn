...
public class QuestManager : MonoBehaviour
{
 ...
 private void Update()
 {
    if(Input.GetKeyDown(KeyCode.Q) && !isQuestMenuOpen && !PlacementSystem.Instance.inPlacementMode)
    {
...
public void RefreshQuestList()
{
    ...
    foreach(Quest activeQuest in allActiveQuests)
    {
        ...
        qRow.questOutpost.text = activeQuest.questOutpost;
        qRow.isActive = true;
    ...
    foreach(Quest completedQuest in allCompletedQuests)
    {
        ...
        qRow.questOutpost.text = completedQuest.questOutpost;
        qRow.isActive = true;
        qRow.isTracking = true;
